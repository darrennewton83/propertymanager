...
namespace ServiceTests.property
{
    public class PropertyTests : Fixture
    {
        ...
        {
            var sut = new Property(4, PropertyType.SemiDetachedHouse, this.SampleAddress, 100000, new DateOnly(2023, 01, 17), true, 2, "some notes");
            Assert.Equal(4, sut.Id);
            Assert.Equal(PropertyType.SemiDetachedHouse, sut.Type);
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => new Property(id, PropertyType.Apartment, this.SampleAddress, null, null, false, null, ""));
        }

        [Fact]
        public void GivenNullAddress_Ctor_ThrowsArgumentNullException()
        {
            Assert.Throws<ArgumentNullException>(() => new Property(1, PropertyType.Apartment, null, null, null, false, null, ""));
        }
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => new Property(1, PropertyType.Apartment, this.SampleAddress, purchasePrice, null, false, null, ""));
        }

        [Fact]
        public void GivenPurchasePriceNotSet_Ctor_ThrowsArgumentOutOfRangeException()
        {
            var sut =  new Property(1, PropertyType.Apartment, this.SampleAddress, null, null, false, null, "");

...
namespace ServiceTests.property.DataStores
{
    public class SqlPropertyDataStoreTests
    {
        ...
        public class SaveAsync : Fixture
        {
            ...
            {
                var sut = new MicrosoftSqlServerPropertyDataStore(Connection, Logger);
                var property = new Property(new PropertyType(1, "Apartment"), new Service.address.Address("line 1", "line 2", "City", "County", "postcode"), null, null, true, 2, "some notes");
            ...
            {
                var sut = new MicrosoftSqlServerPropertyDataStore(Connection, Logger);
                var property = new Property(new PropertyType(1, "Apartment"), new Service.address.Address("line 1", "line 2", "City", "County", "postcode"), null, new DateOnly(2023, 02, 06), true, null, "some notes");
                Connection.ExecuteScalarAsync(Arg.Any<string>(),
            ...
            {
                var sut = new MicrosoftSqlServerPropertyDataStore(Connection, Logger);
                var property = new Property(new PropertyType(1, "Apartment"), new Service.address.Address("line 1", "line 2", "City", "County", "postcode"), null, new DateOnly(2023, 02, 06), true, 2, string.Empty);
                Connection.ExecuteScalarAsync(Arg.Any<string>(),
            ...
            {
                var sut = new MicrosoftSqlServerPropertyDataStore(Connection, Logger);
                var property = new Property(new PropertyType(1, "Apartment"), new Service.address.Address("line 1", string.Empty, "City", "County", "postcode"), null, new DateOnly(2023, 02, 06), true, 2, "some notes");
                Connection.ExecuteScalarAsync(Arg.Any<string>(),
            ...
            {
                var sut = new MicrosoftSqlServerPropertyDataStore(Connection, Logger);
                var property = new Property(new PropertyType(1, "Apartment"), new Service.address.Address("line 1", "line 2", "City", string.Empty, "postcode"), null, new DateOnly(2023, 02, 06), true, 2, "some notes");
                Connection.ExecuteScalarAsync(Arg.Any<string>(),
            ...
            {
                var sut = new MicrosoftSqlServerPropertyDataStore(Connection, Logger);
                var property = new Property(2, new PropertyType(1, "Apartment"), new Service.address.Address("line 1", "line 2", "City", "County", "postcode"), 100000, new DateOnly(2023, 02, 06), true, 2, "some notes");

namespace Service.property
{
    ...
    public class Property : IProperty
    {
        ...
        public Property (int id, PropertyType type, IAddress address, decimal? purchasePrice, DateOnly? purchaseDate, bool garage, byte? numberOfParkingSpaces, string notes)
        {
            if (id <= 0)
            {

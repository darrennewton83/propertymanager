    ...
    public class PropertyControllerTests
    {
        public class Get : Fixture
        {
            ...
            public async Task GivenValidIdAndExists_Get_ReturnsContent()
            {
                ...
                var property = await response.Content.ReadFromJsonAsync<PropertyApiDto>();
        ...
        public class Save : Fixture
        {
            ...
            {
                var property = new PropertyApiDto { Id = 4, Type = "test", AddressLine1 = "", AddressLine2 = "", City = "", Region = "", PostalCode = "", Notes = "" };
            ...
            {
                var property = new PropertyApiDto { Type = "test", AddressLine1 = "line1", AddressLine2 = "", City = "city", Region = "", PostalCode = "postcode", Notes = "fail" };
            ...
            {
                var property = new PropertyApiDto { Type = "A property type", AddressLine1 = "line1", AddressLine2 = "line2", City = "city", Region = "region", PostalCode = "postcode", Notes = "some notes", Garage = true, NumberOfParkingSpaces = 3, PurchaseDate = new DateOnly(2023,02,21), PurchasePrice = 10000000 };

                var payload = new StringContent(JsonConvert.SerializeObject(property), Encoding.UTF8, "application/json");

                var response = await Client.PostAsync("/Property/", payload);
                var content = await response.Content.ReadFromJsonAsync<PropertyApiDto>();
        ...
        public class Update : Fixture
        {
            ...
            {
                var property = new PropertyApiDto { Type = "test", AddressLine1 = "", AddressLine2 = "", City = "", Region = "", PostalCode = "", Notes = "" };
            ...
            public async Task GivenValidRequestFailed_Post_ReturnsErrorMessage()
            {
                var property = new PropertyApiDto { Id = 123, Type = "test", AddressLine1 = "line1", AddressLine2 = "", City = "city", Region = "", PostalCode = "postcode", Notes = "fail" };
            ...
            {
                var property = new PropertyApiDto { Id = 10, Type = "A property type", AddressLine1 = "line1", AddressLine2 = "line2", City = "city", Region = "region", PostalCode = "postcode", Notes = "some notes", Garage = true, NumberOfParkingSpaces = 3, PurchaseDate = new DateOnly(2023, 02, 21), PurchasePrice = 10000000 };

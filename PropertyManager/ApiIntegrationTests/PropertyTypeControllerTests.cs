    ...
    public class PropertyTypeControllerTests
    {
        ...
        public class Get : Fixture
        {
            ...
            public async Task GivenValidIdAndExists_Get_ReturnsContent()
            {
                ...
                var content = await response.Content.ReadFromJsonAsync<PropertyTypeApiDto>();
        ...
        public class Save : Fixture
        {
            ...
            {
                var propertyType = new PropertyTypeApiDto { Id = 4, Name = "test" };
            ...
            {
                var propertyType = new PropertyTypeApiDto { Name = "fail" };
            ...
            {
                var propertyType = new PropertyTypeApiDto { Name = "test" };
        ...
        public class Update : Fixture
        {
            ...
            public async Task GivenValidRequestFailed_Post_ReturnsErrorMessage()
            {
                var propertyType = new PropertyTypeApiDto { Id = 123, Name = "fail" };
            ...
            public async Task GivenValidRequest_Post_ReturnsCreated()
            {
                var propertyType = new PropertyTypeApiDto { Id = 999, Name = "test" };

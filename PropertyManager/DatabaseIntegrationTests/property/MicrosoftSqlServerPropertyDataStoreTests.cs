namespace DatabaseIntegrationTests.property
{
    ...
    public class MicrosoftSqlServerPropertyDataStoreTests
    {
        public class SaveAsync : Fixture
        {
            ...
            {
                var sut = new MicrosoftSqlServerPropertyDataStore(new MicrosoftSqlServer(this.DatabaseLogger, ConnectionString), Logger);
        ...
        public class DeleteAsync : Fixture
        {
            ...
            public async void GivenRecordExists_DeleteAsync_ReturnsTrue()
            {
                ...
                var connection = new MicrosoftSqlServer(this.DatabaseLogger, ConnectionString);
